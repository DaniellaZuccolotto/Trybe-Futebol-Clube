...
describe('Rota /teams', () => {
  ...
  describe('Rota GET /', () => {
    // beforeEach(async () => sinon.stub(TeamModel.prototype, 'findAll').resolves(ARRAY_TEAMS));
    // afterEach(() => (TeamModel.prototype.findAll as sinon.SinonStub).restore());
  ...
  describe('Rota GET /:id', () => {
    // before(async () => sinon.stub(TeamModel.prototype, 'getById').resolves(ARRAY_TEAMS[0]));
    // after(() => (TeamModel.prototype.getById as sinon.SinonStub).restore());
  ...
  describe('Rota GET /:id', () => {
    // before(async () => sinon.stub(TeamModel.prototype, 'getById').resolves(null));
    // after(() => (TeamModel.prototype.getById as sinon.SinonStub).restore());
